...
func Load() Config {
	...
	return Config{
		...
		MaxRequestBodyBytes:  getenvInt64OrDefault("API_MAX_REQUEST_BODY_BYTES", 1<<20),
		EnableRateLimit:      getenvBoolOrDefault("API_RATE_LIMIT_ENABLED", enableRateLimitDefault),
		GlobalRateLimitRPS:   getenvIntOrDefault("API_RATE_LIMIT_RPS", 30),
		GlobalRateLimitBurst: getenvIntOrDefault("API_RATE_LIMIT_BURST", 90),
		AuthRateLimitRPS:     getenvIntOrDefault("API_AUTH_RATE_LIMIT_RPS", 5),
		AuthRateLimitBurst:   getenvIntOrDefault("API_AUTH_RATE_LIMIT_BURST", 10),
	}
}
